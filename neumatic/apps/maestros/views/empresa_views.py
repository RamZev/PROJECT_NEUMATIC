...
class DataViewList():
	...
	table_headers = {
		'nombre_fiscal': (1, 'Nom. Fiscal'),
        'nombre_comercial': (2, 'Nom. Comercial'),
        'id_localidad': (1, 'Localidad'),
        'id_provincia': (1, 'Provincia'),
		'inicio_actividad': (2, 'Inic. Actvidad'),
        'telefono': (1, 'Teléfono'),
        'email_empresa': (2, 'Email'),
		'acciones': (2, 'Acciones'),
	}
	
	table_data = [
		{'field_name': 'nombre_fiscal', 'date_format': None},
        {'field_name': 'nombre_comercial', 'date_format': None},
		...
		{'field_name': 'email_empresa', 'date_format': None},  
	]
