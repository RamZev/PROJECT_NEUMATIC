...
class DataViewList():
	...
	table_headers = {
		'nombre_vendedor': (1, 'Nombre'),
		'email_vendedor': (2, 'Email'),
        'telefono_vendedor': (2, 'Teléfono'),
        'id_sucursal': (1, 'Sucursal'),
        'tipo_venta': (1, 'Tipo Venta'),
        'info_saldo': (1, 'Info. Saldo'),
        'info_estadistica': (2, 'Info. Estadística'),
		'acciones': (2, 'Acciones'),
	}
	
	table_data = [
		{'field_name': 'nombre_vendedor', 'date_format': None},
        {'field_name': 'email_vendedor', 'date_format': None},
        {'field_name': 'telefono_vendedor', 'date_format': None},
        {'field_name': 'id_sucursal', 'date_format': None},
        {'field_name': 'tipo_venta', 'date_format': None},
        {'field_name': 'info_saldo', 'date_format': None},
        {'field_name': 'info_estadistica', 'date_format': None},
