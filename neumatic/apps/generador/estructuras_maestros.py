...
estructura_campos = {
    ...
    'producto': {
        'Información Producto': {
            ...
            'fila_3': [
                {'field_name': 'cai', 'columna': 2},
                {'field_name': 'medida', 'columna': 2},
                {'field_name': 'segmento', 'columna': 2},
                {'field_name': 'unidad', 'columna': 2},
                {'field_name': 'fecha_fabricacion', 'columna': 2},
            ],
            'fila_4': [
                {'field_name': 'costo', 'columna': 2},
                {'field_name': 'alicuota_iva', 'columna': 2},
                {'field_name': 'precio', 'columna': 2},
                {'field_name': 'descuento', 'columna': 2},
            ],
            'fila_5': [
                {'field_name': 'stock', 'columna': 2},
                {'field_name': 'minimo', 'columna': 2},
                {'field_name': 'despacho_1', 'columna': 2},
                {'field_name': 'despacho_2', 'columna': 2},
            ],
            'fila_6': [
