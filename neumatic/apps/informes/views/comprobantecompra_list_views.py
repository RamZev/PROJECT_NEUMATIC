...
class DataViewList:
	...
	table_data = [
		...
		{'field_name': 'codigo_afip_c', 'date_format': None},
		{'field_name': 'codigo_afip_m', 'date_format': None},
	]


class ComprobanteCompraInformeListView(InformeListView):
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorComprobanteCompraForm(self.request.GET or None)
...
class ComprobanteCompraInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = ComprobanteCompraInformeListView()
...
class ComprobanteCompraInformePDFView(View):
