...
class LocalidadInformeListView(InformeListView):
...
class LocalidadInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = LocalidadInformeListView()
...
class LocalidadInformePDFView(View):
