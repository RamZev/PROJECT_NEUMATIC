...
class MedioPagoInformeListView(InformeListView):
	...
	def get_queryset(self):
		...
		if form.is_valid():
			...
			if estatus:
				match estatus:
					case "activos":
						queryset = self.model.objects.filter(estatus_medio_pago=True)
					case "inactivos":
						queryset = self.model.objects.filter(estatus_medio_pago=False)
					case "todos":
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorMedioPagoForm(self.request.GET or None)
...
class MedioPagoInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = MedioPagoInformeListView()
...
class MedioPagoInformePDFView(View):
