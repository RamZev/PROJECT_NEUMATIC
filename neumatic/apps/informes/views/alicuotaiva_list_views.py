...
class AlicuotaIvaInformeListView(InformeListView):
	...
	def get_queryset(self):
		...
		if form.is_valid():
			...
			if estatus:
				match estatus:
					case "activos":
						queryset = self.model.objects.filter(estatus_alicuota_iva=True)
					case "inactivos":
						queryset = self.model.objects.filter(estatus_alicuota_iva=False)
					case "todos":
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorAlicuotaIvaForm(self.request.GET or None)
...
class AlicuotaIvaInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = AlicuotaIvaInformeListView()
...
class AlicuotaIvaInformePDFView(View):
