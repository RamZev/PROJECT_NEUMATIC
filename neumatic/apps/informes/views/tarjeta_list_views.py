...
class TarjetaInformeListView(InformeListView):
	...
	def get_queryset(self):
		...
		if form.is_valid():
			...
			if estatus:
				match estatus:
					case "activos":
						queryset = self.model.objects.filter(estatus_tarjeta=True)
					case "inactivos":
						queryset = self.model.objects.filter(estatus_tarjeta=False)
					case "todos":
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorTarjetaForm(self.request.GET or None)
...
class TarjetaInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = TarjetaInformeListView()
...
class TarjetaInformePDFView(View):
