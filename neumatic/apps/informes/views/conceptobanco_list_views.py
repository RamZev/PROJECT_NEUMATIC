...
class ConceptoBancoInformeListView(InformeListView):
	...
	def get_queryset(self):
		...
		if form.is_valid():
			...
			if estatus:
				match estatus:
					case "activos":
						queryset = self.model.objects.filter(estatus_concepto_banco=True)
					case "inactivos":
						queryset = self.model.objects.filter(estatus_concepto_banco=False)
					case "todos":
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorConceptoBancoForm(self.request.GET or None)
...
class ConceptoBancoInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = ConceptoBancoInformeListView()
...
class ConceptoBancoInformePDFView(View):
