...
class DataViewList:
	...
	table_headers = {
		...
		'nombre_producto_familia': (10, 'Nombre Producto Familia'),
		'comision_operario': (1, 'Comisión Operario(%)'),
	}
...
class ProductoFamiliaInformeListView(InformeListView):
	...
	def get_queryset(self):
		...
		if form.is_valid():
			...
			if estatus:
				match estatus:
					case "activos":
						queryset = self.model.objects.filter(estatus_producto_familia=True)
					case "inactivos":
						queryset = self.model.objects.filter(estatus_producto_familia=False)
					case "todos":
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorProductoFamiliaForm(self.request.GET or None)
...
class ProductoFamiliaInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = ProductoFamiliaInformeListView()
...
class ProductoFamiliaInformePDFView(View):
