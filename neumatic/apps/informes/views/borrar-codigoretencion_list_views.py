...
class CodigoRetencionInformeListView(InformeListView):
	...
	def get_queryset(self):
		...
		if form.is_valid():
			...
			if estatus:
				match estatus:
					case "activos":
						queryset = self.model.objects.filter(estatus_cod_retencion=True)
					case "inactivos":
						queryset = self.model.objects.filter(estatus_cod_retencion=False)
					case "todos":
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorCodigoRetencionForm(self.request.GET or None)
...
class CodigoRetencionInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = CodigoRetencionInformeListView()
...
class CodigoRetencionInformePDFView(View):
