...
class ProductoDepositoInformeView(InformeFormView):
	...
	def obtener_queryset(self, cleaned_data):
		...
		if estatus:
			match estatus:
				case "activos":
					queryset = ConfigViews.model.objects.filter(estatus_producto_deposito=True).select_related("id_sucursal")
				case "inactivos":
					queryset = ConfigViews.model.objects.filter(estatus_producto_deposito=False).select_related("id_sucursal")
				case "todos":
