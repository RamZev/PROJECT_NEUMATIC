...
class ProductoModeloInformeListView(InformeListView):
	...
	def get_queryset(self):
		...
		if form.is_valid():
			...
			if estatus:
				match estatus:
					case "activos":
						queryset = self.model.objects.filter(estatus_modelo=True)
					case "inactivos":
						queryset = self.model.objects.filter(estatus_modelo=False)
					case "todos":
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorProductoModeloForm(self.request.GET or None)
...
class ProductoModeloInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = ProductoModeloInformeListView()
...
class ProductoModeloInformePDFView(View):
