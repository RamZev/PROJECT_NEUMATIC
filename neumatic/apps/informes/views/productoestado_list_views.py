...
class DataViewList:
	...
	table_headers = {
		...
		'estado_producto': (1, 'Estado Producto'),
		'nombre_producto_estado': (10, 'Descripción Estado'),
	}
...
class ProductoEstadoInformeListView(InformeListView):
	...
	def get_queryset(self):
		...
		if form.is_valid():
			...
			if estatus:
				match estatus:
					case "activos":
						queryset = self.model.objects.filter(estatus_producto_estado=True)
					case "inactivos":
						queryset = self.model.objects.filter(estatus_producto_estado=False)
					case "todos":
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorProductoEstadoForm(self.request.GET or None)
...
class ProductoEstadoInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = ProductoEstadoInformeListView()
...
class ProductoEstadoInformePDFView(View):
