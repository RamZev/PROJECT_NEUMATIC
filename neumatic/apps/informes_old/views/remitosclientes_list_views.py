# neumatic\apps\informes\views\remitosclientes_list_views.py
...
class VLRemitosClientesInformeListView(InformeListView):
	...
	def get_context_data(self, **kwargs):
		...
		form = BuscadorRemitosClientesForm(self.request.GET or None)
...
class VLRemitosClientesInformesView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		queryset_filtrado = VLRemitosClientesInformeListView()
...
class VLRemitosClientesInformePDFView(View):
	...
	def get(self, request, *args, **kwargs):
		...
		if form.is_valid():
			...
			reporte = 'informes/reportes/remitosclientes_pdf.html'
			param = {
