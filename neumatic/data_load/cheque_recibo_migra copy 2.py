...
from apps.ventas.models.factura_models import Factura, Caja
    ...
    try:
        ...
        for idx, record in enumerate(table, 1):
            try:
                ...
                if comproing_raw and nrocomproing_raw and caja_numero:
                    ...
                    if comproing and nrocomproing:
                        ...
                        if clave in facturas_cache:
                            factura = facturas_cache[clave]
                            
                            # Buscar caja para asignar
                            caja_obj = cajas_cache.get(caja_numero)
                            
                            if caja_obj:
                                # Actualizar factura con id_caja
                                if factura.id_caja_id != caja_obj.id_caja:
                ...
                # ============================================
                # 3. PROCESAR CHEQUE RECIBO (misma lógica anterior)
                # ============================================
                # Obtener banco
                ...
                if not existe:
                    ...
                    cheque_recibo = ChequeRecibo(
                        id_factura=None,  # No asociamos facturas aquí
                        id_banco=id_banco_instancia,
                ...
                if registros_procesados % 5000 == 0:
                    print(f"<info>Registros procesados: {registros_procesados}/{total_records} | Facturas actualizadas: {facturas_actualizadas_count}</info>")
