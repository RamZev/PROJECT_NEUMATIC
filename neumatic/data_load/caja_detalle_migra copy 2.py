    ...
    try:
        ...
        for idx, record in enumerate(table, 1):
            try:
                ...
                # ============================================
                # 5. OBSERVACIÓN - MEJOR MANEJO
                # ============================================
                observacion_raw = record.get('OBSERVACION')
                observacion = ''
                ...
                if observacion_raw is not None:
                    ...
                    try:
                        observacion = observacion.encode('latin-1').decode('utf-8', errors='ignore')
                    except:
                        pass  # Si falla, usar el string original
                ...
                # ============================================
                # 6. VERIFICAR SI EL REGISTRO YA EXISTE - MÁS FLEXIBLE
                # ============================================
                # Crear filtro base
                filtro_base = {
                    'id_caja': caja_obj,
                ...
                # Para observación, usar Q objects para manejar None/cadena vacía
                from django.db.models import Q
                
                existe = CajaDetalle.objects.filter(
                    Q(**filtro_base) &
                    (Q(observacion=observacion) | Q(observacion='') | Q(observacion__isnull=True))
                ).exists()
                ...
                caja_detalle = CajaDetalle(
                    ...
                    observacion=observacion or ''  # Asegurar cadena vacía si es None
                )
